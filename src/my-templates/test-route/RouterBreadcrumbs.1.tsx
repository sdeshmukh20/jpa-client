...
function buildListContent(moduleState:StateWrap,action:()=>void){
return (          <List>
  <ListItemLink to="/inbox" open={moduleState.open}  />
  <Collapse component="li" in={moduleState.open} timeout="auto" unmountOnExit>
    <List >
  ...
  return (
    <MemoryRouter initialEntries={['/inbox']} initialIndex={0}>
      <Box sx={{ display: 'flex', flexDirection: 'column', width: 360 }}>
        ...
        >
          <List>
            <ListItemLink to="/inbox" open={moduleState.open} onClick={handleClick} />
            <Collapse component="li" in={moduleState.open} timeout="auto" unmountOnExit>
              <List >
                <ListItemLink sx={{ pl: 4 }} to="/inbox/important" />
                <Collapse component="li" in={moduleState.open} timeout="auto" unmountOnExit>
